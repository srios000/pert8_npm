...
// PORT const is the const of the port :D
const PORT = 9080 //ubdah port sesuai dengan NPM kalian masing - masing. contoh: jika npm 54422423 maka portnya 22423
...
func user(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodGet {
		...
		result, err := json.Marshal(dataMahasiswa) // ubah variabel dataMahasiswa menjadi json
