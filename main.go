...
const PORT = 22690 //ubdah port sesuai dengan NPM kalian masing - masing. contoh: jika npm 54422423 maka portnya 22423

func main() {
	http.HandleFunc("/api/mahasiswa", user)                         // buat route untuk api/mahasiswa
	http.Handle("/", http.FileServer(http.Dir("polymer_51422690"))) // buat route untuk file statis
...
var dataMahasiswa = []lepkom{
	{
		Nama:   "Zulfa Aulia Hanafi",
		Kursus: "Fundamental Golang",
		Foto:   "img/gambar1.jpg",
	},
	{
		Nama:   "Zulfa Aulia Hanafi",
		Kursus: "Fundamental for Beginner",
		Foto:   "img/gambar2.png",
	},
	{
		Nama:   "Zulfa Aulia Hanafi",
		Kursus: "Fundamental for Intermediate",
